...
template <typename T> T __acpp_sscp_work_group_broadcast(__acpp_int32, T) = delete;

#define ACPP_TEMPLATE_DECLARATION_WG_BROADCAST(size)                                               \
  template <>                                                                                      \
  __acpp_int##size __acpp_sscp_work_group_broadcast<__acpp_int##size>(__acpp_int32 id,             \
                                                                      __acpp_int##size value);
