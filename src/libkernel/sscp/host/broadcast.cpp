...
__acpp_##input_type __acpp_sscp_work_group_broadcast_##fn_suffix(__acpp_int32 sender, \
      ...
      __acpp_##input_type* shrd_x = static_cast<__acpp_##input_type*>(__acpp_sscp_host_get_internal_local_memory()); \
      return __acpp_sscp_work_group_broadcast_impl(sender, x, shrd_x); \
    } \
