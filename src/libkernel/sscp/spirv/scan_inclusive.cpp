...
#define GROUP_FLOAT_EXCLUSIVE_SCAN(type)                                                           \
  ...
  __acpp_##type __acpp_sscp_work_group_inclusive_scan_##type(__acpp_sscp_algorithm_op op,          \
    ...
    switch (op) {                                                                                  \
    case __acpp_sscp_algorithm_op::plus:                                                           \
      return generic_scan_impl<shmem_array_length, false>(x, plus{}, &shrd_mem[0]);                \
    case __acpp_sscp_algorithm_op::multiply:                                                       \
      return generic_scan_impl<shmem_array_length, false>(x, multiply{}, &shrd_mem[0]);            \
    case __acpp_sscp_algorithm_op::min:                                                            \
      return generic_scan_impl<shmem_array_length, false>(x, min{}, &shrd_mem[0]);                 \
    case __acpp_sscp_algorithm_op::max:                                                            \
      return generic_scan_impl<shmem_array_length, false>(x, max{}, &shrd_mem[0]);                 \
    default:                                                                                       \
      return __acpp_##type{};                                                                      \
    }                                                                                              \
  }
...
#define GROUP_INT_EXCLUSIVE_SCAN(fn_suffix, type)                                                  \
  ...
  __acpp_##type __acpp_sscp_work_group_inclusive_scan_##fn_suffix(__acpp_sscp_algorithm_op op,     \
    ...
    case __acpp_sscp_algorithm_op::max:                                                            \
      return generic_scan_impl<shmem_array_length, false>(x, max{}, &shrd_mem[0]);                 \
    case __acpp_sscp_algorithm_op::bit_and:                                                        \
      return generic_scan_impl<shmem_array_length, false>(x, bit_and{}, &shrd_mem[0]);             \
    case __acpp_sscp_algorithm_op::bit_or:                                                         \
      return generic_scan_impl<shmem_array_length, false>(x, bit_or{}, &shrd_mem[0]);              \
    case __acpp_sscp_algorithm_op::bit_xor:                                                        \
      return generic_scan_impl<shmem_array_length, false>(x, bit_xor{}, &shrd_mem[0]);             \
    case __acpp_sscp_algorithm_op::logical_and:                                                    \
      return generic_scan_impl<shmem_array_length, false>(x, logical_and{}, &shrd_mem[0]);         \
    case __acpp_sscp_algorithm_op::logical_or:                                                     \
      return generic_scan_impl<shmem_array_length, false>(x, logical_or{}, &shrd_mem[0]);          \
    default:                                                                                       \
      return __acpp_##type{};                                                                      \
    }                                                                                              \
  }
